...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  $('renderLocation').value = state.renderLocation || 'markerFolder';
  ...
  $('renderLocation').addEventListener('change', async () => {
    try {
      await patchState({ renderLocation: $('renderLocation').value || 'markerFolder' });
      setStatus('Saved.');
    } catch (e) {
      setStatus(e.message);
    }
